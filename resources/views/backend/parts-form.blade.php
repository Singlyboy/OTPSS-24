...
@csrf
  <div class="form-group">
    ...
    <input name="par_name" type="text" class="form-control" id="name" placeholder="Enter Parts Name">
  </div>
  ...
  <div class="form-group">
    ...
    <textarea class="form-control" name="par_price" id="" placeholder="Enter Prats price"></textarea>
  </div>
  <div class="form-group">
